...
export const initialData: SeedData = {
  users: [
    ...
    {
      nickname: '7611058',
      fullName: 'Tobias Alexander Alderete Gimenez',
      password: '7611058',
      roles: [ValidRoles.user],
    },
    {
      nickname: '7488999',
      fullName: 'Zulma Noemi Barreto Caballero',
      password: '7488999',
      roles: [ValidRoles.user],
    },
    {
      nickname: '7230113',
      fullName: 'Cristobal Gabriel Barreto Mendez',
      password: '7230113',
      roles: [ValidRoles.user],
    },
    {
      nickname: '7438035',
      fullName: 'Ezequiel Barreto Ruiz',
      password: '7438035',
      roles: [ValidRoles.user],
    },
    {
      nickname: '7393866',
      fullName: 'Jeremias Benjamin Britez Insfran',
      password: '7393866',
      roles: [ValidRoles.user],
    },
    {
      nickname: '7820840',
      fullName: 'Rodrigo Misael Cardozo Estigarribia',
      password: '7820840',
      roles: [ValidRoles.user],
    },
    {
      nickname: '7597627',
      fullName: 'Angel David Cardozo Portillo',
      password: '7597627',
      roles: [ValidRoles.user],
    },
    {
      nickname: '7215585',
      fullName: 'Leryn Aylen Castro Florentin',
      password: '7215585',
      roles: [ValidRoles.user],
    },
    {
      nickname: '7454947',
      fullName: 'Ruth Guadalupe Cespedes Villalba',
      password: '7454947',
      roles: [ValidRoles.user],
    },
    {
      nickname: '7285535',
      fullName: 'Felippe Lucas Benjamin Da Silva',
      password: '7285535',
      roles: [ValidRoles.user],
    },
    {
      nickname: '7489603',
      fullName: 'Mathias Jose Gonzalez De Paula',
      password: '7489603',
      roles: [ValidRoles.user],
    },
    {
      nickname: '7503236',
      fullName: 'Jackelin Abigail Duarte Enciso',
      password: '7503236',
      roles: [ValidRoles.user],
    },
    {
      nickname: '7624069',
      fullName: 'Samira Magali Falcon Escobar',
      password: '7624069',
      roles: [ValidRoles.user],
    },
    {
      nickname: '7865104',
      fullName: 'Luz Yamila Fariña Gimenez',
      password: '7865104',
      roles: [ValidRoles.user],
    },
    {
      nickname: '195',
      fullName: 'Deisy Jazmin Gaona Barrios',
      password: '195',
      roles: [ValidRoles.user],
    },
    {
      nickname: '7174199',
      fullName: 'Ciro Samir Gauto Sosa',
      password: '7174199',
      roles: [ValidRoles.user],
    },
    {
      nickname: '8026230',
      fullName: 'Kemily Victoria Goncalves De Oliveira',
      password: '8026230',
      roles: [ValidRoles.user],
    },
    {
      nickname: '7366851',
      fullName: 'Jonathan David Jara Zaracho',
      password: '7366851',
      roles: [ValidRoles.user],
    },
    {
      nickname: '7425623',
      fullName: 'Matheo Agustin Lezcano Avalos',
      password: '7425623',
      roles: [ValidRoles.user],
    },
    {
      nickname: '7450560',
      fullName: 'Alejandra Anahi Lezcano Vera',
      password: '7450560',
      roles: [ValidRoles.user],
    },
    {
      nickname: '7501439',
      fullName: 'Alan Gabriel Lopez Carmona',
      password: '7501439',
      roles: [ValidRoles.user],
    },
    {
      nickname: '52701250',
      fullName: 'Elias Lopez Romero',
      password: '52701250',
      roles: [ValidRoles.user],
    },
    {
      nickname: '7263887',
      fullName: 'Lucas Ignacio Martinez Caceres',
      password: '7263887',
      roles: [ValidRoles.user],
    },
    {
      nickname: '8179330',
      fullName: 'Naomi Anahir Medina Espinola',
      password: '8179330',
      roles: [ValidRoles.user],
    },
    {
      nickname: '7432659',
      fullName: 'Iker Josias Mendoza Cardozo',
      password: '7432659',
      roles: [ValidRoles.user],
    },
    {
      nickname: '186',
      fullName: 'Tamara Lujan Noguera Solis',
      password: '186',
      roles: [ValidRoles.user],
    },
    {
      nickname: '7516849',
      fullName: 'Fiorella Jazmin Parra Franco',
      password: '7516849',
      roles: [ValidRoles.user],
    },
    {
      nickname: '7325044',
      fullName: 'Cristhian David Pereira Romero',
      password: '7325044',
      roles: [ValidRoles.user],
    },
    {
      nickname: '31',
      fullName: 'Lucas Daniel Romero Vega',
      password: '31',
      roles: [ValidRoles.user],
    },
    {
      nickname: '7226422',
      fullName: 'Juan Angel Vallejos Aguirre',
      password: '7226422',
      roles: [ValidRoles.user],
    },
    {
      nickname: '7414003',
      fullName: 'Oscar Daniel Vargas Cristaldo',
      password: '7414003',
      roles: [ValidRoles.user],
    },
    {
      nickname: '7489622',
      fullName: 'Ares Nahuel Zamphiropolos Sanchez',
      password: '7489622',
      roles: [ValidRoles.user],
    },
  ],
  ...
  surveys: [
    ...
    {
      question: '¿Qué tan útil fue la página web para aprender?',
      surveyOptions: [
